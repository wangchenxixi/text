...
const classmate = dynamic({
    component: () => import('@/views/Meun/markingManagement/classmate/classmate'),
});
const ClassSpecial = dynamic({
    component: () => import('@/views/Meun/markingManagement/ClassSpecial/ClassSpecial'),
});
