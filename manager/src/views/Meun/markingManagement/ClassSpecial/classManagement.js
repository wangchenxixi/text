...
class ClassManagement extends Component {
    ...
    {
        console.log(val)
        // hashHistory.push("http://localhost:8000/#/class/classmate")
    }
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => (
                    <span>
                        <a onClick={() => {this.click(text)}}>批卷</a>
                    </span>
                ),
            },
        ];
        ...
        return (
            <div className={classManagementStyle.wrap}>
                <p className={classManagementStyle.title}>待批班级</p>
