        ...
        <div className={styles.markcont}>
            ...
            <Form.Item>
                {getFieldDecorator('title', {
                    ...
                    initialValue: props.questionsOnlyData.title
                })(
            ...
            <Form.Item>
                {getFieldDecorator('questions_stem', {
                    initialValue:  props.questionsOnlyData.questions_stem
                })(
                    <Editor height="auto"/>
                )}
            </Form.Item>        
        ...
        <div>
            ...
            <Form.Item>
                {getFieldDecorator('exam_id', {
                    rules: [{ required: true, message: '请输入题目标题!' }],
                    initialValue: props.questionsOnlyData.exam_id
                })(
        ...
        <div>
            ...
            <Form.Item>
                {getFieldDecorator('subject_id', {
                    rules: [{ required: true, message: '请输入题目标题!' }],
                    initialValue: props.questionsOnlyData.subject_id
                })(
                    <Select style={{ width: 160 }}>
                    {                
        ...
        <div>
            ...
            <Form.Item>
                {getFieldDecorator('questions_type_id', {
                    rules: [{ required: true, message: '请输入题目标题!' }],
                    initialValue: props.questionsOnlyData.questions_type_id
                })(
                    <Select style={{ width: 160 }}>
                    {                
        ...
        <div className={styles.markcont}>
            ...
            <Form.Item>
                {getFieldDecorator('questions_answer', {
                    initialValue: props.questionsOnlyData.questions_answer
                })(
                    <Editor height="auto" />
                )}
            </Form.Item> 
...
const mapDispatchToProps=dispatch=>{
    return{ 
        ...
        // 获取单个试题
        questionsOnly(payload){
            dispatch({
                type: "questions/questionsOnly",
                payload
            })
        },
        // 更新试题
        questionsUpdate(payload){
            dispatch({
                type: "questions/questionsUpdate",
                payload
            })
        },
    }
